...
const DetailQuiz = (props) => {
    ...
    return (
        <>
            <Breadcrumb className="quiz-detai-new-header" style={{ padding: "20px" }}>
                <NavLink style={{ textDecoration: "none" }} to='/' className='breadcrumb-item'>
                    {t('header1.home')}
                </NavLink>
                <NavLink style={{ textDecoration: "none" }} to='/users' className='breadcrumb-item'>
                    {t('header1.user')}
                </NavLink>
                ...
                <div className="left-content">
                    ...
                    <div className="footer">
                        <button className="btn btn-secondary"
                            onClick={() => handlePrev()}
                        >{t('header1.prev')}</button>
                        <button
                            onClick={() => handleNext()}
                            className="btn btn-primary">{t('header1.next')}</button>

                        <button
                            disabled={isSubmitQuiz}
                            onClick={() => handleFinishQuiz()}
                            className="btn btn-warning">{t('header1.finish')}</button>
                    </div>
                </div>
